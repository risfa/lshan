...
<body>
    <div class="container">
        ...
        <h3 align="center">Jawaban Survey</h3>
        <br/>
        <div class="row">
            <div class="col-md-4">
                <table>
...
<script>
    $(document).ready(function() {
        function fetch_data() {
            $.ajax({
                url: "pages/tb_jawaban_survey/select.php",
                method: "POST",
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            if (Jawaban == '') {
                alert("Isi Jawaban Survey Tidak Boleh kosong");
                return false;
            }

            $.ajax({
                url: "pages/tb_jawaban_survey/insert.php",
                method: "POST",
                data: {
                    Jawaban: Jawaban
                },
        ...
        function edit_data(id, text, column_name) {
            $.ajax({
                url: "pages/tb_jawaban_survey/edit.php",
                method: "POST",
                data: {
                    id: id,
                    text: text,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "pages/tb_jawaban_survey/delete.php",
                    method: "POST",
                    data: {
                        id: id
                    },
