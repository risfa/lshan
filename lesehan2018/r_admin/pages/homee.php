                ...
                <div class="widget big-stats-container">
                    <div class="widget-content">
                        <div id="big_stats" class="cf">
                            <div class="stat"> <h1>MOBIL</h1> <span class="value">000</span> </div>
                            <!-- .stat -->

                            <div class="stat"> <h1>MOTOR</h1> <span class="value">000</span> </div>
                            <!-- .stat -->
                            <div class="stat"> <h1>TOTAL</h1> <span class="value">000</span> </div>
                            <!-- .stat -->
                        </div>
                    </div>
                    <!-- /widget-content -->
         ...
         <div class="widget widget-nopad">
            ...
            <div class="widget-content">
                <div class="widget big-stats-container">
                    <div class="widget-content">
                        <div id="big_stats" class="cf">
                            <div class="stat"> <h1>RACING</h1> <span class="value">000</span> </div>
                            <!-- .stat -->

                            <div class="stat"> <h1>MATIC</h1> <span class="value">000</span> </div>
                            <!-- .stat -->
                            <div class="stat"> <h1>TOTAL</h1> <span class="value">000</span> </div>
                            <!-- .stat -->
                        </div>
